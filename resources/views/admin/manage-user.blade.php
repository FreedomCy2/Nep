...
<head>
    ...
    <title>Manage Users - Clinic Flow</title>
    ...
    <div class="w-64 bg-white shadow-lg h-screen fixed">
        ...
        <nav class="mt-6">
            ...
            <div class="mt-3">
                ...
                <a href="/admin/manage-users" class="flex items-center px-6 py-3 text-gray-600 hover:bg-[#68D6EC]/10 sidebar-item active-route">
        ...
        <div class="bg-white rounded-lg shadow-sm p-8 text-center">
            <div class="max-w-md mx-auto">
                <div class="bg-red-100 p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    <i data-feather="users" class="text-red-500 text-2xl"></i>
                </div>
                <h3 class="text-xl font-semibold text-gray-800 mb-2">Users Management</h3>
                <p class="text-gray-500 mb-6">This page will contain the users management interface. Content will be added here later.</p>
